...
export default class Networking {
    ...
    constructor(clientId, oauth2Token, userId) {
        this._clientId = clientId;
        this._authorization = this.getAuthToken(oauth2Token);
        this._userId = userId;
        this._crossDomain = this.corsSupport();
    }

    /**
     * PRIVATE. it uses the oauth2 access_token returned from https://api.mangopay.com/v2.01/oauth/token/ 
     * @param {string} oauth2Token
     */
    getAuthToken(oauth2Token) {
